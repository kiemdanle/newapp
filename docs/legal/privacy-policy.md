...
This Privacy Policy explains what data Expyrico ("we", "us") collects, how we use it, and the choices you have. Expyrico is a self-hosted expiry tracker. We do not sell your data. We do not embed third-party analytics.
...
- **Expiry records:** items you add (name or scanned product, quantity, expiry date, optional photo, optional notes). These are private to your account.
...
- **Push notification token:** if you grant notification permission, we store the Firebase Cloud Messaging token associated with your device so we can send expiry reminders.
...
- Operate the service: sign you in, store your expiry records, deliver notifications, show product information, accept and display reviews
...
- **Service providers:**
  ...
  - **Firebase Cloud Messaging** — receives your push token and notification payload
  - **Configured backup storage provider** — receives encrypted backups of the database
...
- **Expiry records:** until you delete them, or for 90 days after account deletion in encrypted backups
...
We do not knowingly collect data from children under 13. If we learn we have
...
Questions? Email the operator's published privacy contact.
