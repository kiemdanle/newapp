...
| A5 | **M2** — Reviews + ratings | Backend phases **A–H** + API verification (reviews/votes/reports/Wilson/profanity/workers). Mobile phases I–L → Track B. |
...
| B3 | **M2** — Reviews + ratings | Mobile phases **I–L** (review hooks, components, screens, Maestro). |
