...
export declare const recordSchema: z.ZodObject<{
    ...
    photoUrls: z.ZodOptional<z.ZodNullable<z.ZodArray<z.ZodEffects<z.ZodString, string, string>, "many">>>;
...
export declare const recordPhotoUploadResponseSchema: z.ZodObject<{
