...
module.exports = {
  ...
  transformIgnorePatterns: [
    'node_modules/.pnpm/(?!(.*?(react-native|@react-native|@react-native-community|expo|@expo|expo-.*|@expo/.*|react-navigation|@react-navigation|nativewind|react-native-.*|@tanstack|zustand|uuid)))',
  ],
};
