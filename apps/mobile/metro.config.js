...
// every transitive dep would have to be hoisted as a direct dependency. Letting
// Metro walk the directory tree from each importing file lets it find pnpm-nested
// deps.
...
config.resolver.resolveRequest = (context, moduleName, platform) => {
  // Prefer the monorepo-hoisted react package. A nested apps/mobile/node_modules/react
  // may be absent under pnpm, which breaks Metro SHA-1 during release bundling.
