  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        {/*
          `next/font/google` is the lint-preferred loader, but switching to it
          here is a real behavioral change, not a one-line fix —
          ...
          visual-regression risk across every page in the app. That's a
          pre-existing, unrelated concern — suppressed here deliberately
          rather than left as an unexplained failing gate.
        */}
